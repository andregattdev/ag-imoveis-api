...
public interface ImovelRepository extends JpaRepository<Imovel, Long> {
    ...
    List<Imovel> findByAtivoTrueAndCidadeContainingIgnoreCaseOrAtivoTrueAndBairroContainingIgnoreCase(String cidade,
            String bairro);

    // Conta total de imóveis
    long count();

    long countByTipoAndAtivoTrue(TipoImovel tipo);

    long countByFinalidadeAndAtivoTrue(Finalidade finalidade);
